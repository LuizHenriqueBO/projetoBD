...
INSERT INTO `banco_utfpr`.`modelo` (`descricaoModelo`, `marca_idmarca`) VALUES ('Sedan 4 portas flex 1.6', '1');
INSERT INTO `banco_utfpr`.`modelo` (`descricaoModelo`, `marca_idmarca`) VALUES ('hatch 4 portas 1.0', '2');
INSERT INTO `banco_utfpr`.`modelo` (`descricaoModelo`, `marca_idmarca`) VALUES ('sedan 4 portas 2.0', '3');
INSERT INTO `banco_utfpr`.`modelo` (`descricaoModelo`, `marca_idmarca`) VALUES ('hatch 2 portas 1.8', '4');
INSERT INTO `banco_utfpr`.`modelo` (`descricaoModelo`, `marca_idmarca`) VALUES ('hatch 2 portas 1.6 trail', '1');
INSERT INTO `banco_utfpr`.`modelo` (`descricaoModelo`, `marca_idmarca`) VALUES ('hatch 2 portas 1.0', '3');

INSERT INTO `banco_utfpr`.`carro` (`chassi`, `ano`, `descricaoCarro`, `modelo_idmodelo`) VALUES ('1253', '2017', 'fiesta', '1');
INSERT INTO `banco_utfpr`.`carro` (`chassi`, `ano`, `descricaoCarro`, `modelo_idmodelo`) VALUES ('2534', '2017', 'cruze', '2');
INSERT INTO `banco_utfpr`.`carro` (`chassi`, `ano`, `descricaoCarro`, `modelo_idmodelo`) VALUES ('6534', '2017', 'uno', '6');
INSERT INTO `banco_utfpr`.`carro` (`chassi`, `ano`, `descricaoCarro`, `modelo_idmodelo`) VALUES ('4265', '2017', 'palio', '3');
INSERT INTO `banco_utfpr`.`carro` (`chassi`, `ano`, `descricaoCarro`, `modelo_idmodelo`) VALUES ('2598', '2017', 'M3 turbo', '4');
INSERT INTO `banco_utfpr`.`carro` (`chassi`, `ano`, `descricaoCarro`, `modelo_idmodelo`) VALUES ('1455', '2017', 'focus', '1');
